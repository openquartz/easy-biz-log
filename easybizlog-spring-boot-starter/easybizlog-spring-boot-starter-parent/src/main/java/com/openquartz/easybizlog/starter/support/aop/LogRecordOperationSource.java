...
import com.openquartz.easybizlog.core.annotation.LogRecords;
...
public class LogRecordOperationSource {
    ...
    public Collection<LogRecordOps> computeLogRecordOperations(Method method, Class<?> targetClass) {
        ...
        Collection<LogRecordOps> abstractLogRecordsOps = parseLogRecordsAnnotations(
    ...
    private Collection<LogRecordOps> parseLogRecordsAnnotations(AnnotatedElement ae) {
        ...
        Collection<LogRecords> logRecordAnnotationAnnotations = AnnotatedElementUtils.findAllMergedAnnotations(ae,
            LogRecords.class);
    ...
    private Collection<LogRecordOps> parseLogRecordAnnotations(AnnotatedElement ae) {
        Collection<LogRecord> logRecordAnnotationAnnotations = AnnotatedElementUtils.findAllMergedAnnotations(ae,
            LogRecord.class);
    ...
    private void validateLogRecordOperation(AnnotatedElement ae, LogRecordOps recordOps) {
        if (!StringUtils.hasText(recordOps.getSuccessLogTemplate()) && !StringUtils.hasText(
            recordOps.getFailLogTemplate())) {
